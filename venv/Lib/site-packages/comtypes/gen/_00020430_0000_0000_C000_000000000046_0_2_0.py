...
__all__ = [
    'FontEvents', 'StdFont', 'Monochrome', 'OLE_YSIZE_PIXELS',
    'OLE_CANCELBOOL', 'OLE_XSIZE_PIXELS', 'Font',
    'OLE_ENABLEDEFAULTBOOL', 'OLE_XSIZE_HIMETRIC', 'FONTITALIC',
    'OLE_XPOS_HIMETRIC', 'FONTNAME', 'OLE_XPOS_CONTAINER',
    'OLE_OPTEXCLUSIVE', 'Picture', 'Gray', 'OLE_YSIZE_CONTAINER',
    'IPictureDisp', 'Checked', 'VgaColor', 'FONTUNDERSCORE',
    'OLE_XSIZE_CONTAINER', 'IFontEventsDisp', 'OLE_HANDLE',
    'StdPicture', 'IFontDisp', 'IFont', 'FONTBOLD', 'FONTSIZE',
    'Unchecked', 'FONTSTRIKETHROUGH', 'OLE_YPOS_CONTAINER',
    'OLE_YPOS_HIMETRIC', 'Color', 'OLE_YSIZE_HIMETRIC', 'OLE_COLOR',
    'OLE_TRISTATE', 'Default', 'OLE_XPOS_PIXELS', 'OLE_YPOS_PIXELS',
    'IPicture', 'LoadPictureConstants'
]

_check_version('1.2.0', 1247529555.877464)
