...
__all__ = [
    'UIA_AccessKeyPropertyId', 'UIA_Selection_InvalidatedEventId',
    'TextUnit_Page', 'UIA_WindowPatternId', 'TreeScope_Descendants',
    'UIA_WindowIsModalPropertyId',
    'UIA_IsTableItemPatternAvailablePropertyId',
    'IUIAutomationTreeWalker', 'UIA_ProviderDescriptionPropertyId',
    'ScrollAmount', 'UIA_IsMultipleViewPatternAvailablePropertyId',
    'UIA_TabItemControlTypeId',
    'UIA_ScrollHorizontallyScrollablePropertyId',
    'UIA_FontWeightAttributeId',
    'UIA_InputReachedOtherElementEventId', 'UIA_NamePropertyId',
    'UIA_MenuBarControlTypeId', 'UIA_SelectionItemPatternId',
    'UIA_InputDiscardedEventId', 'TextUnit_Line',
    'PropertyConditionFlags',
    'UIA_SelectionItem_ElementAddedToSelectionEventId',
    'TextUnit_Document', 'UIA_OverlineStyleAttributeId',
    'UIA_LegacyIAccessibleKeyboardShortcutPropertyId',
    'TextUnit_Character', 'UIA_BulletStyleAttributeId',
    'UIA_IsItalicAttributeId', 'UIA_ScrollVerticalViewSizePropertyId',
    'UIA_GridItemColumnSpanPropertyId', 'IAccessible',
    'IUIAutomationPropertyChangedEventHandler',
    'AutomationElementMode', 'UIA_DataItemControlTypeId',
    'IUIAutomationElementArray', 'UIA_RadioButtonControlTypeId',
    'UIA_InputReachedTargetEventId', 'OrientationType_Vertical',
    'UIA_ThumbControlTypeId', 'UIA_Text_TextSelectionChangedEventId',
    'UIA_DockDockPositionPropertyId', 'UIA_TogglePatternId',
    'TextUnit_Format', 'UIA_ControllerForPropertyId',
    'ProviderOptions_ClientSideProvider', 'OrientationType',
    'IUIAutomation', 'UIA_MenuControlTypeId',
    'UIA_LegacyIAccessibleStatePropertyId',
    'UIA_SelectionIsSelectionRequiredPropertyId',
    'AutomationElementMode_Full', 'UIA_SliderControlTypeId',
    'UIA_TitleBarControlTypeId', 'UIA_AnimationStyleAttributeId',
    'IUIAutomationScrollItemPattern',
    'UIA_IsKeyboardFocusablePropertyId', 'IUIAutomationDockPattern',
    'UIA_ScrollHorizontalViewSizePropertyId',
    'StructureChangeType_ChildRemoved',
    'ExpandCollapseState_Expanded', 'UIA_ImageControlTypeId',
    'StructureChangeType_ChildrenReordered', 'UIA_TablePatternId',
    'UIA_MenuModeEndEventId', 'UIA_IsGridPatternAvailablePropertyId',
    'UIA_GridItemContainingGridPropertyId',
    'UIA_AcceleratorKeyPropertyId', 'UIA_IsControlElementPropertyId',
    'UIA_SelectionItemIsSelectedPropertyId',
    'UIA_Text_TextChangedEventId', 'IUIAutomationGridItemPattern',
    'SynchronizedInputType_RightMouseDown', 'UIA_TabsAttributeId',
    'IUIAutomationEventHandler', 'UIA_ClickablePointPropertyId',
    'IUIAutomationSynchronizedInputPattern',
    'UIA_IsExpandCollapsePatternAvailablePropertyId',
    'ProviderOptions_ProviderOwnsSetFocus',
    'WindowInteractionState_Closing', 'SupportedTextSelection_Single',
    'UIA_IsEnabledPropertyId', 'SynchronizedInputType_RightMouseUp',
    'UIA_TreeItemControlTypeId', 'UIA_AutomationIdPropertyId',
    'WindowInteractionState_Running', 'UIA_SelectionPatternId',
    ...
    'UIA_WindowCanMinimizePropertyId', 'UIA_CapStyleAttributeId',
    'ToggleState_Indeterminate', 'UIA_ListItemControlTypeId',
    'UIA_IndentationFirstLineAttributeId',
    'RowOrColumnMajor_RowMajor', 'UIA_ItemTypePropertyId',
    'UIA_SplitButtonControlTypeId', 'IUIAutomationScrollPattern',
    'UIA_IsPasswordPropertyId', 'UIA_ToolTipOpenedEventId',
    'UIA_IsRangeValuePatternAvailablePropertyId',
    'IUIAutomationVirtualizedItemPattern', 'UIA_GridPatternId',
    'UIA_IndentationLeadingAttributeId',
    'UIA_StrikethroughColorAttributeId',
    'UIA_TransformCanResizePropertyId', 'IUIAutomationWindowPattern',
    'IUIAutomationTableItemPattern', 'UIA_GridItemPatternId',
    'UIA_WindowWindowVisualStatePropertyId', 'TreeScope_Children',
    'ScrollAmount_LargeDecrement', 'ToggleState_On',
    'UIA_TransformCanMovePropertyId',
    'UIA_ScrollHorizontalScrollPercentPropertyId',
    'TreeScope_Subtree', 'UIA_LegacyIAccessibleValuePropertyId',
    'IUIAutomationMultipleViewPattern',
    'UIA_VirtualizedItemPatternId', 'WindowInteractionState',
    'UIA_StrikethroughStyleAttributeId',
    'UIA_IsSynchronizedInputPatternAvailablePropertyId',
    'WindowVisualState_Maximized',
    'IUIAutomationExpandCollapsePattern',
    'UIA_LayoutInvalidatedEventId', 'UIA_OrientationPropertyId',
    'TextPatternRangeEndpoint_Start',
    'IUIAutomationLegacyIAccessiblePattern',
    'UIA_IsWindowPatternAvailablePropertyId',
    'UIA_IsDockPatternAvailablePropertyId',
    'ExpandCollapseState_Collapsed', 'SynchronizedInputType_KeyDown',
    'IUIAutomationGridPattern', 'UIA_MenuOpenedEventId',
    'TextPatternRangeEndpoint', 'CUIAutomation',
    'IUIAutomationProxyFactoryEntry', 'TextUnit',
    'IUIAutomationRangeValuePattern', 'UIA_ComboBoxControlTypeId',
    'IUIAutomationTablePattern', 'UIA_RuntimeIdPropertyId',
    'UIA_LegacyIAccessibleNamePropertyId',
    'PropertyConditionFlags_None',
    'UIA_TableItemColumnHeaderItemsPropertyId',
    'UIA_GridItemRowPropertyId', 'RowOrColumnMajor_Indeterminate',
    'SynchronizedInputType', 'UIA_DocumentControlTypeId',
    'UIA_MenuModeStartEventId', 'UIA_BoundingRectanglePropertyId',
    'UIA_FlowsToPropertyId',
    'IUIAutomationStructureChangedEventHandler',
    'UIA_MultipleViewSupportedViewsPropertyId',
    'UIA_MarginTrailingAttributeId', 'UIA_MarginBottomAttributeId',
    'UIA_MultipleViewPatternId', 'SupportedTextSelection_Multiple',
    'UIA_IsReadOnlyAttributeId', 'UIA_HyperlinkControlTypeId',
    'UIA_CalendarControlTypeId', 'UIA_ValuePatternId',
    'TreeScope_Element', 'TextPatternRangeEndpoint_End',
    'UIA_DockPatternId', 'UIA_GridItemColumnPropertyId',
    'StructureChangeType_ChildrenBulkAdded',
    'UIA_RangeValueMinimumPropertyId',
    'IUIAutomationTransformPattern', 'UIA_UnderlineStyleAttributeId',
    'ToggleState_Off', 'IUIAutomationTextRange',
    'UIA_TableItemPatternId', 'UIA_ValueIsReadOnlyPropertyId',
    'UIA_ToolBarControlTypeId', 'UIA_IsContentElementPropertyId',
    'UIA_LegacyIAccessibleSelectionPropertyId',
    'UIA_WindowIsTopmostPropertyId', 'UIA_CustomControlTypeId',
    'UIA_ToggleToggleStatePropertyId', 'UIA_TextControlTypeId',
    'UIA_AsyncContentLoadedEventId', 'UIA_RangeValueValuePropertyId',
    'UIA_FrameworkIdPropertyId',
    'UIA_IsInvokePatternAvailablePropertyId',
    'UIA_ProcessIdPropertyId', 'UIA_IsHiddenAttributeId',
    'UIA_AutomationFocusChangedEventId',
    'SynchronizedInputType_KeyUp', 'ExpandCollapseState',
    'SupportedTextSelection_None', 'DockPosition_Right',
    'UIA_HeaderControlTypeId', 'UIA_Window_WindowClosedEventId',
    'StructureChangeType', 'UIA_HelpTextPropertyId',
    'UIA_TableColumnHeadersPropertyId', 'UIA_PaneControlTypeId',
    'UIA_ScrollVerticalScrollPercentPropertyId',
    'UIA_IsTransformPatternAvailablePropertyId',
    'UIA_IsSelectionPatternAvailablePropertyId',
    'UIA_ListControlTypeId', 'SynchronizedInputType_LeftMouseUp',
    'ScrollAmount_SmallIncrement',
    'UIA_TextFlowDirectionsAttributeId', 'UIA_IsSubscriptAttributeId',
    'IUIAutomationAndCondition', 'RowOrColumnMajor',
    'UIA_HeaderItemControlTypeId', 'IUIAutomationElement',
    'AutomationElementMode_None', 'UIA_CheckBoxControlTypeId',
    'SupportedTextSelection', 'UIA_Window_WindowOpenedEventId',
    'UIA_TreeControlTypeId', 'UIA_ItemContainerPatternId',
    'UIA_ScrollItemPatternId', 'UIA_UnderlineColorAttributeId',
    'DockPosition', 'UIA_LabeledByPropertyId',
    'UIA_IsDataValidForFormPropertyId', 'TreeScope',
    ...
    'ScrollAmount_LargeIncrement', 'UIA_HasKeyboardFocusPropertyId',
    'UIA_IsScrollItemPatternAvailablePropertyId',
    'IUIAutomationInvokePattern', 'UIA_TabControlTypeId',
    ...
    'UIA_BackgroundColorAttributeId', 'UIA_EditControlTypeId',
    'UIA_TableControlTypeId', 'UIA_NativeWindowHandlePropertyId',
    'UIA_MultipleViewCurrentViewPropertyId',
    'IUIAutomationTextRangeArray', 'UIA_GridRowCountPropertyId',
    'UIA_ClassNamePropertyId',
    'UIA_IsTogglePatternAvailablePropertyId',
    'UIA_RangeValueIsReadOnlyPropertyId',
    'UIA_IsTextPatternAvailablePropertyId',
    'UIA_LegacyIAccessibleDescriptionPropertyId',
    'UIA_SpinnerControlTypeId', 'UIA_FontSizeAttributeId',
    'UIA_ToolTipClosedEventId', 'UIA_WindowCanMaximizePropertyId',
    'UIA_SeparatorControlTypeId',
    'UIA_IsScrollPatternAvailablePropertyId',
    'UIA_StatusBarControlTypeId', 'IRawElementProviderSimple',
    'IUIAutomationItemContainerPattern', 'UIA_InvokePatternId',
    'UIA_IsValuePatternAvailablePropertyId', 'DockPosition_Fill',
    'UIA_TransformCanRotatePropertyId', 'ScrollAmount_NoAmount',
    'UIA_DescribedByPropertyId',
    'UIA_SelectionCanSelectMultiplePropertyId',
    'SynchronizedInputType_LeftMouseDown',
    'UIA_TableItemRowHeaderItemsPropertyId',
    'UIA_RangeValuePatternId', 'UIA_MarginLeadingAttributeId',
    'UIA_ScrollVerticallyScrollablePropertyId', 'TextUnit_Word',
    'UIA_ValueValuePropertyId', 'UIA_ForegroundColorAttributeId',
    'IUIAutomationOrCondition', 'UIA_AriaRolePropertyId',
    'UIA_IsLegacyIAccessiblePatternAvailablePropertyId',
    'UIA_IsSelectionItemPatternAvailablePropertyId',
    'IUIAutomationProxyFactory', 'TreeScope_Parent',
    'UIA_GridItemRowSpanPropertyId', 'UIA_TableRowHeadersPropertyId',
    'UIA_WindowWindowInteractionStatePropertyId',
    'UIA_WindowControlTypeId',
    'UIA_SelectionItem_ElementRemovedFromSelectionEventId',
    'OrientationType_None', 'UIA_LegacyIAccessibleRolePropertyId',
    'UIA_GroupControlTypeId',
    'WindowInteractionState_ReadyForUserInteraction',
    'UIA_TextPatternId', 'ExpandCollapseState_PartiallyExpanded',
    'IUIAutomationNotCondition', 'UIA_IsSuperscriptAttributeId',
    'UIA_SelectionItemSelectionContainerPropertyId',
    'ProviderOptions_UseComThreading', 'UIA_MarginTopAttributeId',
    'UIA_DataGridControlTypeId', 'IUIAutomationTogglePattern',
    'UIA_IndentationTrailingAttributeId', 'IUIAutomationValuePattern',
    'UIA_TableRowOrColumnMajorPropertyId', 'TreeScope_Ancestors',
    'OrientationType_Horizontal', 'DockPosition_Left',
    'PropertyConditionFlags_IgnoreCase',
    'IUIAutomationProxyFactoryMapping', 'UIA_ScrollBarControlTypeId',
    'StructureChangeType_ChildrenBulkRemoved',
    'IUIAutomationPropertyCondition',
    'UIA_LegacyIAccessibleDefaultActionPropertyId',
    'WindowVisualState', 'ProviderOptions_ServerSideProvider',
    'UIA_ExpandCollapsePatternId', 'ScrollAmount_SmallDecrement',
    'UIA_GridColumnCountPropertyId', 'UIA_ToolTipControlTypeId',
    'ToggleState', 'IUIAutomationSelectionPattern',
    'WindowInteractionState_NotResponding',
    'StructureChangeType_ChildrenInvalidated',
    'UIA_TransformPatternId', 'UIA_AutomationPropertyChangedEventId',
    'UIA_Invoke_InvokedEventId', 'WindowVisualState_Normal',
    'UIA_HorizontalTextAlignmentAttributeId',
    'UIA_SelectionSelectionPropertyId', 'UIA_CultureAttributeId',
    'UIA_MenuItemControlTypeId', 'UIA_OverlineColorAttributeId',
    'DockPosition_None', 'UIA_AriaPropertiesPropertyId',
    'WindowVisualState_Minimized', 'UIA_IsOffscreenPropertyId',
    'UIA_ControlTypePropertyId', 'UIA_ProgressBarControlTypeId',
    'UIA_ScrollPatternId', 'TextUnit_Paragraph',
    'DockPosition_Bottom', 'IUIAutomationBoolCondition',
    'ExpandCollapseState_LeafNode', 'IUIAutomationTextPattern',
    'IUIAutomationCacheRequest', 'UIA_IsRequiredForFormPropertyId',
    'UIA_CulturePropertyId', 'UIA_MenuClosedEventId',
    'UIA_LocalizedControlTypePropertyId', 'UIA_FontNameAttributeId',
    'ProviderOptions_NonClientAreaProvider',
    'UIA_SelectionItem_ElementSelectedEventId',
    'RowOrColumnMajor_ColumnMajor',
    'UIA_RangeValueSmallChangePropertyId', 'IUIAutomationCondition',
    'UIA_ButtonControlTypeId', 'ProviderOptions',
    'UIA_StructureChangedEventId'
]

_check_version('1.2.0', 1247535715.387000)
